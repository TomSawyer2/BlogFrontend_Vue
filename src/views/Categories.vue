...
<div v-if="show">
    ...
    <a-row type="flex" justify="center">
      <a-col :span="18">
        ...
        <div>
          <Article style="display: flex; justify-content: center" :articles="articles" :loading="loading" :reverse="reverseFather"/>
        </div>
      </a-col>
    </a-row>
    ...
    <a-button v-if="addBtnShow" shape="circle" icon="appstore" size="large" class="addArticleBtn" @click="toAll"/>
  </div>
  <div v-else>
    <NavigationBar :current="currentTab"/> 
...
export default {
  name: 'Index',
  components: { NavigationBar, Article, WordCloudChart },
  data() {
    return {
      articles: [],
      show: false,
